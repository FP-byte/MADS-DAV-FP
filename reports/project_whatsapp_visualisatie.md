...
De onderwerpen in de chats volgen een duidelijk patroon, dat zichtbaar wordt door de toepassing van dimensiereductie via t-SNE. Vooral thema's rondom eten en berichten naar tieners met het verzoek "kom thuis" komen samen in herkenbare clusters, die in de visualisatie in het blauw worden weergegeven. Een belangrijk inzicht is dat de voorkeurstaal is met de context afhankelijk, zo is het Italiaans hovooral handig in gesprekken over eten en tijdens vakanties, wat duideijk te zien is in de taalkluster.
